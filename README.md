Hi, I’m **Sharvari Mehta** — an SDET who designs **clean Automation Testing frameworks** and solid **API tests** with smooth **CI/CD**. Exploring **GenAI** to supercharge test design and coverage.
